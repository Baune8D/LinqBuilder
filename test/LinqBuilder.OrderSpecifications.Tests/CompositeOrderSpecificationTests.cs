...
namespace LinqBuilder.OrderSpecifications.Tests
{
    public class CompositeOrderSpecificationTests
    {
        ...
        private static IEnumerable<Entity> GetTestList()
        {
            return new List<Entity>
            {
                new Entity { Value1 = 3 },
                new Entity { Value1 = 1, Value3 = 2 },
                new Entity { Value1 = 2, Value2 = 1 },
                new Entity { Value1 = 2, Value2 = 2 },
                new Entity { Value1 = 1, Value3 = 1 }
            };
        }
    }
}
